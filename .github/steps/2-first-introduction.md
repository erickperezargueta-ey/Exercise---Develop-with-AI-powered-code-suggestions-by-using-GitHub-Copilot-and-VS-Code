...
1. Find the `app.py` file and press the `+` sign to collect your changes together in the staging area.
   ...
   ![image](https://github.com/erickperezargueta-ey/Exercise---Develop-with-AI-powered-code-suggestions-by-using-GitHub-Copilot-and-VS-Code/blob/main/.github/images/staging-changes-icon.png?raw=true)
